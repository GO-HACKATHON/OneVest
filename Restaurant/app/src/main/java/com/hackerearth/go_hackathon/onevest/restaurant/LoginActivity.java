...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference(ChildData.resto);
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                databaseReference.child(UID).addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(DataSnapshot dataSnapshot) {
                                        RestoData.name = dataSnapshot.child(ChildData.name).getValue().toString();
                                        RestoData.email = dataSnapshot.child(ChildData.email).getValue().toString();
                                        RestoData.UID = UID;
